...
lazy val base = (project in file("."))
  .aggregate(
    ...
    exercise_019_use_ask_pattern,
    exercise_020_akka_extension,
    exercise_021_fsm)
...
lazy val exercise_007_use_schedular = project
  .settings(commonSettings: _*)
  .dependsOn(common % "test->test;compile->compile")
...
lazy val exercise_019_use_ask_pattern = project
  .settings(commonSettings: _*)
  .dependsOn(common % "test->test;compile->compile")

lazy val exercise_020_akka_extension = project
  .settings(commonSettings: _*)
  .dependsOn(common % "test->test;compile->compile")

lazy val exercise_021_fsm = project
  .settings(commonSettings: _*)
  .dependsOn(common % "test->test;compile->compile")
